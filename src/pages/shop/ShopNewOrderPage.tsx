...
export function ShopNewOrderPage() {
  ...
  const filteredGroups = useMemo(() => {
    // ⚡ Bolt: Using deferredQuery to prevent typing latency during search.
    // The input updates immediately, but the expensive Fuse.js search is deferred.
          ...
          <div className="flex items-center gap-3 rounded-xl bg-emerald-600 px-5 py-3 shadow-lg shadow-emerald-900/20">
            ...
            {factoryNumber && (
              <a
                ...
                className="flex items-center gap-1.5 rounded-lg bg-[#25D366] px-3 py-1.5 text-xs font-semibold text-white shadow-sm hover:bg-[#1ebe5d]"
              >
