...
export function ShopAvailablePage() {
  ...
  return (
    ...
    >
      ...
      {lines.length > 0 ? (
        <div className="fixed bottom-0 left-0 right-0 z-30 border-t border-slate-200 dark:border-slate-800/50 bg-white/90 dark:bg-slate-900/90 backdrop-blur p-3 sm:p-4 shadow-[0_-4px_24px_rgba(0,0,0,0.08)] transition-colors duration-200">
