      ...
      {open && (
        <div className="fixed inset-0 z-50 flex items-end justify-center sm:items-center sm:p-6">
          ...
          <motion.div
            ...
            className="relative z-10 w-full max-w-lg rounded-t-2xl border border-slate-200 dark:border-slate-800/50 bg-white dark:bg-slate-900 transition-colors duration-200 shadow-2xl sm:rounded-2xl"
          >
